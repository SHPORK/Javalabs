...
public class Lab1 extends JFrame {
    ...
    private static final int SERVER_PORT = 4540;
    private static final String SERVER_ADDRESS = "localhost";
    private UpdateTableTask UTT;
    public Lab1() {
        ...
        connectMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    UTT = new UpdateTableTask(tableModel, socket);
                    UTT.start();
        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (table.getRowCount() > 1) {
                    ...
                    lastRowIndex = table.getRowCount();
                }
                ...
                try {
                    if (thread3.getStep() == 3) {
                        tableModel.addRow(new Object[]{lowerBound, upperBound, intervals, thread3.getFinalResult()});                  
